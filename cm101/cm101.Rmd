...
```{r}
x <- 1:10
mmm2(x) # did not need to stoer this in x, could've used v. Even if you use "x" in the function, it is a "dummy" variable
```
...
qd2(rnorm(100), probs =c(.25, .75)) #default is overwritten
```
